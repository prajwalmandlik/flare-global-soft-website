    ...
    <div id="about">
      ...
      <div className="about-intern" >
          ...
          <div className="about-intern-text">
            <p>
            Tech Elevate: Elevating Careers, Transforming Futures.
            </p>
          </div>
      </div>
        </section>
      ...
      <section className="vision container">
        ...
        <div className="vision-content">
            ...
            <div className="vision-description">
                <p>Dedicated to delivering cutting-edge solutions in our Internship Program, fostering goal achievement and professional advancement.</p>
            </div>
            ...
            <div className="vision-subpoint">
                ...
                <div className="vision-subpoint-description">
                    <h3>Mission:</h3>
                    <p>Empowering emerging innovators with experiential learning.</p>
                </div>
            </div>
            ...
            <div className="vision-icon"><i class='bx bx-run'></i></div>
                <div className="vision-subpoint-description">
                    <h3>Vision:</h3>
                    <p>Pioneering transformative education, bridging the academia-industry gap towards excellence in technology.</p>
                </div>
            </div>

            <div className="vision-start-button">
            <HashLink to={"/Internship#Internship"} >
